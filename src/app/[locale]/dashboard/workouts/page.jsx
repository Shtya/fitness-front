...
export default function ExercisesPage() {
	...
	return (
		<div className='space-y-6'>
			{/* Header / Stats */}
			<GradientStatsHeader onClick={() => setAddOpen(true)} btnName={ user?.role == "admin" && t('actions.addExercise')} title={t('descriptions.exercises')} desc={t('descriptions.manageLibrary')} loadingStats={loadingStats}>
				{
					user?.role == "admin" && <>
