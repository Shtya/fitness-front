    ...
    <div className={`${className}`}>
      ...
      {alerting && (
        <div className='bounce-in mb-2'>
          <button
            onClick={stopAlert}
            className='w-full inline-flex items-center justify-center gap-2 rounded-lg border px-3 py-2 text-xs font-semibold transition-all hover:scale-[1.01] active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2'
            style={{
