...
export default function Img({
  ...
  // If you keep a file in /public/icons/no-img.png you can set that here;
  // otherwise we use a data-URI to avoid 404s entirely.
  ...
  // If we're already on the fallback, skip the blurred background to avoid double fetch.
